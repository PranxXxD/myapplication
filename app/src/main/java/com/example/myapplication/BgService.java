...
import android.widget.Toast;
    ...
    */
        ...
        public class GeocoderHandler extends Handler {
            ...
            public void getAddressFromLocation(double latitude, double longitude, Context applicationContext, GeocoderHandler geocoderHandler)
            {
               //
            }
        }
        ...
        public void onShake(float force) {
           ...
           GeocoderHandler data = new GeocoderHandler();
                data.getAddressFromLocation(latitude,longitude,getApplicationContext(), new GeocoderHandler());
